      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>
            Fresh<Text style={styles.titleAccent}>Scan</Text>
          </Text>
          <Text style={styles.subtitle}>
            Snap or upload food — get instant{'\n'}freshness & quality assessment
          </Text>
        </View>
          ...
          <View style={styles.previewWrap}>
            {loading && (
              <View style={styles.scanLineWrap}>
                <LinearGradient
                  colors={['transparent', '#c8f060', 'transparent']}
                  start={{ x: 0, y: 0 }}
                  end={{ x: 1, y: 0 }}
        ...
        {imageUri && !result && (
          ...
          >
            {loading ? (
              <>
                <ActivityIndicator color="#7a7870" size="small" />
                <Text style={styles.analyzeBtnTextLoading}>Scanning…</Text>
              </>
            ) : (
        ...
        {/* Re-scan button when result is shown */}
        {result && (
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              {history.map(item => (
                <View key={item.id} style={styles.historyItem}>
                  ...
                  <View style={[
                    styles.historyBadge,
                    { backgroundColor: VERDICT_CONFIG[item.verdict].color }
                  ]}>
...
const styles = StyleSheet.create({
  ...
  analyzeBtnText: { color: '#0a0a08', fontSize: 16, fontWeight: '700', letterSpacing: 0.3 },
  analyzeBtnTextLoading: { color: '#7a7870', fontSize: 16, fontWeight: '600' },
