...
export default function App() {
  ...
  const [activeTab, setActiveTab]     = useState<'freshness' | 'adulteration'>('freshness');
  ...
  const reset = useCallback(() => { setImageUri(null); setImageB64(null); setResult(null); setNutrition(null); }, []);
      ...
      <View style={styles.tabBar}>
        <TouchableOpacity style={[styles.tabBtn, activeTab === 'freshness' && styles.tabBtnActive]} onPress={() => setActiveTab('freshness')} activeOpacity={0.8}>
          <LinearGradient colors={activeTab === 'freshness' ? ['rgba(212,245,118,0.12)', 'rgba(212,245,118,0.04)'] : ['transparent', 'transparent']} style={styles.tabBtnGrad}>
            <Ionicons name="leaf-outline" size={16} color={activeTab === 'freshness' ? '#d4f576' : '#3a4030'} />
            <Text style={[styles.tabBtnText, activeTab === 'freshness' && styles.tabBtnTextActive]}>Freshness</Text>
          </LinearGradient>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.tabBtn, activeTab === 'adulteration' && styles.tabBtnAdultActive]} onPress={() => setActiveTab('adulteration')} activeOpacity={0.8}>
          <LinearGradient colors={activeTab === 'adulteration' ? ['rgba(248,113,113,0.12)', 'rgba(248,113,113,0.04)'] : ['transparent', 'transparent']} style={styles.tabBtnGrad}>
            <Ionicons name="flask-outline" size={16} color={activeTab === 'adulteration' ? '#f87171' : '#3a4030'} />
            <Text style={[styles.tabBtnText, activeTab === 'adulteration' && styles.tabBtnTextAdult]}>Adulteration 🔬</Text>
          </LinearGradient>
        </TouchableOpacity>
      </View>
